...
public class PlayerManager implements Listener{
    ...
    public int getSettingsInt(UUID uuid, ConfigEnum.PlayerSettings key, String prop, int defaultValue){
    ...
    public void setSettingsInt(UUID uuid, ConfigEnum.PlayerSettings key, String prop, int value){
        PlayerManager manager = PlayerConfig.playerSettings.get(uuid);
        if (manager != null){
            JsonObject data = getOrCreateObject(manager.getSettings(), "Data");
            JsonObject obj = getOrCreateObject(data, key.toString().toLowerCase());
    ...
    public String getSettingsString(UUID uuid, ConfigEnum.PlayerSettings key, String prop, String defaultValue){
        PlayerManager manager = PlayerConfig.playerSettings.get(uuid);
        if (manager != null){
            JsonObject data = getOrCreateObject(manager.getSettings(), "Data");
            JsonObject obj = getOrCreateObject(data, key.toString().toLowerCase());
    ...
    public long getSettingsLong(UUID uuid, ConfigEnum.PlayerSettings key, String prop, long defaultValue){
        PlayerManager manager = PlayerConfig.playerSettings.get(uuid);
        if (manager != null){
            JsonObject data = getOrCreateObject(manager.getSettings(), "Data");
            JsonObject obj = getOrCreateObject(data, key.toString().toLowerCase());
    ...
    public void setSettingsLong(UUID uuid, ConfigEnum.PlayerSettings key, String prop, long value){
        PlayerManager manager = PlayerConfig.playerSettings.get(uuid);
        if (manager != null){
            JsonObject data = getOrCreateObject(manager.getSettings(), "Data");
            JsonObject obj = getOrCreateObject(data, key.toString().toLowerCase());
