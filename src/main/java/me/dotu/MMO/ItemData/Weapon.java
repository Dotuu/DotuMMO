...
public class Weapon extends MasterItem{
    ...
    public Weapon(String name, int durability, short sockets, int dropChance, String dropTable, Material type, ItemEnum.Tier tier) {
